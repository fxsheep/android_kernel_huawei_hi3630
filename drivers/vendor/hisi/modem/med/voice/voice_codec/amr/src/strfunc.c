...
*
*  Function:   search_id
*  Purpose:    search table for id; return string if found, AMR_NULL otherwise
*
**************************************************************************
*/
...
{
    return ((*str = search_id(modetable, (int) mode)) != AMR_NULL);
}
...
{
    return ((*str = search_id(rxframetable, (int) ft)) != AMR_NULL);
}
...
{
    return ((*str = search_id(txframetable, (int) ft)) != AMR_NULL);
}
