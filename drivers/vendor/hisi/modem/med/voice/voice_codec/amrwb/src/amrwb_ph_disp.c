...
static Word16 ph_imp_low[AMRWB_L_SUBFR] =
{
...
static Word16 ph_imp_mid[AMRWB_L_SUBFR] =
{
...
)
{
    ...
    CODEC_OpVecSet(code2, 2 * AMRWB_L_SUBFR, 0);
    ...
    *prev_state = state;
    ...
    if (sub(state, 2) < 0)
    {
        ...
        CODEC_OpVvAdd(&code2[0], &code2[AMRWB_L_SUBFR], AMRWB_L_SUBFR, code);
    }
    return;
}
