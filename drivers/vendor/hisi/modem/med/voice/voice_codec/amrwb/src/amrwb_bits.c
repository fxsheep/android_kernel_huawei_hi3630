...
static Word16 *sort_ptr[16] = { sort_660, sort_885, sort_1265, sort_1425, sort_1585, sort_1825, sort_1985, sort_2305,
                               sort_2385, sort_SID,      0,      0,      0,      0,      0,      0};

const Word16 nb_of_bits[NUM_OF_MODES] = {
    NBBITS_7k,
    NBBITS_9k,
    NBBITS_12k,
    NBBITS_14k,
...
TX_State g_stAmrwbTxState;
RX_State g_stAmrwbRxState;

void Reset_tx_state(void)
{
    g_stAmrwbTxState.sid_update_counter = 3;
    g_stAmrwbTxState.sid_handover_debt = 0;
    g_stAmrwbTxState.prev_ft = TX_SPEECH;
}
...
void wb_sid_sync(TX_State *st, Word16 mode, enum AMRWB_TXFrameType *penTxFrmType)
{
   ...
   {
       st->sid_update_counter = 8;
       *penTxFrmType = TX_SPEECH;
   }
   st->prev_ft = *penTxFrmType;
}

void Reset_rx_state(void)
{
    g_stAmrwbRxState.prev_ft = RX_SPEECH_GOOD;
    g_stAmrwbRxState.prev_mode = 0;
}
