...
#define AMRWB_L_FRAME      256                   /* Frame size                                 */
#define L_SUBFR16k   80                    /* Subframe size at 16kHz                     */

#define AMRWB_L_SUBFR      64                    /* Subframe size                              */
#define NB_SUBFR     4                     /* Number of subframe per frame               */

#define AMRWB_L_NEXT       64                    /* Overhead in LP analysis                    */
#define AMRWB_L_WINDOW     384                   /* window size in LP analysis                 */
#define AMRWB_L_TOTAL      384                   /* Total size of speech buffer.               */
#define AMRWB_M            16                    /* Order of LP filter                         */
#define M16k         20
...
#define AMRWB_PIT_MIN      34                    /* Minimum pitch lag with resolution 1/4      */
...
#define AMRWB_PIT_MAX      231                   /* Maximum pitch lag                          */
#define AMRWB_L_INTERPOL   (16+1)                /* Length of filter for interpolation         */
...
#define MODE_24k      8
#define MRDTX         9
#define NUM_OF_MODES  10                   /* see amrwb_bits.h for bits definition             */

#define AMRWB_EHF_MASK (Word16)0x0008            /* homing frame pattern                       */
