...
#define AMRWB_FRAME_LEN 256                      /* Length (samples) of the input frame          */
#define AMRWB_COMPLEN 12                         /* Number of sub-bands used by VAD              */

#define AMRWB_UNIRSHFT 7                         /* = log2(MAX_16/UNITY), UNITY = 256      */
...
#define AMRWB_NOISE_MAX 20000                    /* maximum */
#define NOISE_INIT 150                     /* initial */

/* Thresholds for signal power (now calculated on 2 frames) */
#define AMRWB_VAD_POW_LOW (Word32)30000L         /* If input power is lower than this, VAD is set to 0 */
