...
#define MED_AEC_HF_NLP_FRM_LEN_NB                (160)                          /* 窄带帧长 */
#define MED_AEC_HF_NLP_FFT_LEN_NB                (320)                          /* 窄带FFT长度 */
#define MED_AEC_HF_NLP_FRM_LEN_WB                (320)                          /* 宽带帧长 */
...
#define MED_AEC_HF_CANCEL_COUNT_THD              (20)                           /* 帧计数器门限 */
...
#define MED_AEC_HF_ECHO_BIN_START                (11)                           /* 窄带参与的回声块起始位置 */
#define MED_AEC_HF_ECHO_BIN_RANGE_NB             (61)                           /* 窄带参与排序的回声块长度 */
#define MED_AEC_HF_ECHO_BIN_RANGE_WB             (121)                          /* 宽带参与排序的回声块长度 */
...
#define MED_AEC_HF_OVRD_HIGH                     (32439)                        /* ovrd滤波高门限 Q15*/
...
#define MED_AEC_HF_NLP_RESDPOW_LOWBAND_8k        (16)                           /* 窄带残差信号能量统计起始频点 */
#define MED_AEC_HF_NLP_RESDPOW_HIGHBAND_8k       (42)                           /* 窄带残差信号能量统计截止频点 */
#define MED_AEC_HF_NLP_RESDPOW_LOWBAND_16k       (30)                           /* 宽带残差信号能量统计起始频点 */
#define MED_AEC_HF_NLP_RESDPOW_HIGHBAND_16k      (82)                           /* 宽带残差信号能量统计截止频点 */
...
typedef struct
{
    CODEC_SWITCH_ENUM_UINT16            enCnFlag;                               /* 插入舒适噪声使能指示 */
