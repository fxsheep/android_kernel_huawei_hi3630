  ...
  *pswMutePermit = 0;
  ...
  else
  {
    ...
    {                                  /* unvoiced good frame */
      ...
      {                                /* unvoiced bad frame */
        CODEC_OpVecCpy(&pswSpeechPara[0],
                     &pswLastGood[0],
                     5);
...
*/
  ...
  else
  {
    ...
    /* ------------------------------------------------------ */
    L_sum = CODEC_OpVecScaleMac(&pswDecodedSpeechFrame[0],
                              S_LEN,
                              0,
                              3);
...
*/
  ...
  /* -------------------------------------------- */
  L_sum = CODEC_OpVecScaleMac(&swOutTmp[0],
                            S_LEN,
                            0,
                            2);
  ...
  if (swPermitMuteSub > 0)
  {
    ...
    /* ----------------------- */
    CODEC_OpVcMultR(&pswSynthFiltState[0],
                  10,
                  psrConceal[swMute - 1],
                  &pswSynthFiltState[0]);

    CODEC_OpVcMultR(&pswPPFExcit[0],
                  S_LEN,
                  psrConceal[swMute - 1],
                  &pswPPFExcit[0]);
    ...
    /* Mute pitch memory: */
    /* ------------------ */
    CODEC_OpVcMultR(&pswLtpStateOut[0],
                  S_LEN,
                  psrConceal[swMute - 1],
                  &pswLtpStateOut[0]);
    ...
    /* ---------------------------- */
    CODEC_OpVcMultR(&pswPPreState[0],
                  S_LEN,
                  psrConceal[swMute - 1],
                  &pswPPreState[0]);
  }
